...
$sql = "select *, DAYOFMONTH(waktu) as tgl, MONTH(waktu) as bln, "
        ...
        . "  from istana.pernakpernik where status='1' and id='$tempid' order by waktu desc limit 1";
$result = $DB->query($sql);
               ...
               <div class="row presidenRI-contentDetail">
                    <div class="col-md-8 contentLeft">
                         ...
                         <div class="contentBerita">
                              ...
                              <?php
                              $sql = "select * from istana.pernakpernik_link where pernakpernik_id='" . $tempid . "' order by id DESC limit 0,5";
                         ...
                         <div class="presidenRI-box arsip">
                              ...
                              <div class="boxContent">
                                   <div id="tanggal" >
                                            ...
                                            <?php
                                             $alamat_web = "$url_rewrite" . "index.php/pernak-pernik";
                                             require_once 'kalender_arsip.php';
                                             prosess_tanggal($tgl, $alamat_web, $days, $status, 15, $DB);
                                             ?>

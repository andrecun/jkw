...
$sql = "select *, DAYOFMONTH(waktu) as tgl, MONTH(waktu) as bln, "
        ...
        . "  from fokus where status='1' and id='$tempid' order by waktu desc limit 7";
$result = $DB->query($sql);
                                   ...
                                   <div class="col-md-12">
                                        <?php if ($data[ContentTypeD] != '') { ?>
                                             <div class="imageContainer">
                                                  <img src="<?php echo$alamat_img; ?>" class="img-responsive imageBerita">
                         ...
                         <div class="presidenRI-box arsip">
                              ...
                              <div class="boxContent">
                                   <div id="tanggal" >
                                            ...
                                            <?php
                                             $alamat_web = "$url_rewrite" . "index.php/berita";
                                             require_once 'kalender_arsip.php';
                                             prosess_tanggal($tgl, $alamat_web, $days, $status, 1, $DB);
                                             ?>

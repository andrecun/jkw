...
$sql = "select *, DAYOFMONTH(waktu) as tgl, MONTH(waktu) as bln, "
        ...
        . "  from pidato where status='1' and id='$tempid' order by waktu desc limit 7";

$result = $DB->query($sql);
$data = $DB->fetch_array($result);
$id = $data['id'];
$ringkasan = $data['cuplikan_id'];
$waktu = $UTILITY->format_tanggal_time_ind($data[waktu]);
$judul = $data['judul_id'];
$alamat_img = "$url_rewrite" . "imagePidatoD.php/" . "$id.jpg";
?>
                         ...
                         <div class="contentBerita">
                              <div class="beritaTitle">
                                   ...
                                   <div class="tagline col-md-10">
                                        ...
                                        <p class="date"><?=$data[tempat]?>, <?= $waktu ?></p>
                                   </div>
                              ...
                              <div class="row">
                                   <div class="col-md-12 text-justify">
                                        <?= nl2br($data[isi_id]) ?><br/>
					 <a href="<?=$url_rewrite?>/DokumenPidato.php/<?=$id?>.pdf " target="_blank">[Download PDF]</a>
                                   </div>
                              </div>
                         ...
                         <div class="presidenRI-box arsip">
                              ...
                              <div class="boxContent">
                                   <div id="tanggal" >
                                            ...
                                            <?php
                                             $alamat_web = "$url_rewrite" . "index.php/pidato";
                                             require_once 'kalender_arsip.php';
                                             prosess_tanggal($tgl, $alamat_web, $days, $status, 7, $DB);
                                             ?>

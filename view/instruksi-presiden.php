          ...
          <div class="container presidenRI-container">
               ...
               <div class="row presidenRI-contentDetail">
                    <div class="col-md-8 contentLeft">
                         <p class="title">Peraturan Perundangan (Instruksi Presiden)</p>
                         <?php
                         $alamat_web = "$url_rewrite" . "index.php/instruksi-presiden";
                         ...
                         $sql = "select *, DAYOFMONTH(waktu) as tgl, MONTH(waktu) as bln, "
                                 ...
                                 . "  from uu where status='1' and kategori='4' and waktu like '$tgl_sistem%' order by waktu desc ";
                         else
                              $sql = "select *, DAYOFMONTH(waktu) as tgl, MONTH(waktu) as bln, "
                                 . "YEAR(waktu) as thn, DATE_FORMAT(waktu, '%H:%i:%s') as jam"
                                 . "  from uu where status='1' and kategori='4' order by waktu desc ";

                         $data = $DB->_fetch_array($sql, 1);
                         if(count($data)>0)
                         foreach ($data as $key => $value) {
                              $clsPath->addPathVarTo("instruksi-presiden", true);
                    ...
                    <div class="col-md-4 contentRight">
                         <!--<div class="presidenRI-box arsip">
                              ...
                              <div class="boxContent">
                                   <div id="tanggal">
                                        <?php
                                             prosess_tanggal($tgl, $alamat_web, $days, $status, 12, $DB);
                                        ?>

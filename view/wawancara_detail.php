...
$sql = "select *, DAYOFMONTH(waktu) as tgl, MONTH(waktu) as bln, "
        ...
        . "  from wawancara where status='1' and id='$tempid' order by waktu desc limit 7";
...
$judul = $data['judul_id'];
$alamat_img = "$url_rewrite" . "imageWawancaraD.php/" . "$id.jpg";
?>
          ...
          <div class="container presidenRI-container">
               ...
               <div class="row presidenRI-contentDetail">
                    <div class="col-md-8 contentLeft">
                         <p class="title">Wawancara & Kolom</p>
                         ...
                         <div class="presidenRI-box arsip">
                              ...
                              <div class="boxContent">
                                   <div id="tanggal" >
                                            ...
                                            <?php
                                             $alamat_web = "$url_rewrite" . "index.php/wawancara";
                                             require_once 'kalender_arsip.php';
                                             prosess_tanggal($tgl, $alamat_web, $days, $status, 8, $DB);
                                             ?>

...
<form action="?file=pernakpernik_detail&amp;id=<?php echo $_GET[id]; ?>#terkait" method="post" enctype="multipart/form-data">
		...
		<td>
			...
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						<?php
						$sql = mysql_query("select *, DAYNAME(waktu) as hari, DAYOFMONTH(waktu) as tgl, MONTH(waktu) as bln, YEAR(waktu) as thn from pernakpernik where id='".$_GET['id']."'");
						...
						<table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
							...
							<tr>
								...
								<td valign="top">:</td>
								<td>
								<?php echo nl2br($row[cuplikan_id]); ?>
								</td>
							</tr>
							<tr>
...
?>
						...
						<table width="100%">
<?php
if(isset($verify_pernakpernik_link))
{
?>
							<tr>
								<td colspan="4"><?php echo "$verify_pernakpernik_link"; ?></td>
							</tr>
...
if($_GET['d']=="edit")
{
$sql="select judul_link, url_link, ringkasan, id as id_link from pernakpernik_link where id='".$_GET['id_link']."'";
...
?>
							...
							<tr>
								...
								<td>&nbsp;</td>
								<td colspan="2"><input class="inputsubmit" type="submit" name="edit_link_pernakpernik" value="Kirim"/>&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>
							<tr>
								<td colspan="4"><hr /></td>
							</tr>
...
$sql="select *, id as id_link from pernakpernik_link where pernakpernik_id='".$_GET['id']."' order by id desc limit 0,5";
...
?>
							<tr>
								...
								<td align="right">&bull;<a href="?file=pernakpernik_detail&amp;id=<?php echo $_GET[id]; ?>&amp;d=edit&amp;id_link=<?php echo $row[$i][id_link]; ?>#terkait"> Perubahan</a> &bull; <a href="?file=pernakpernik_detail&amp;id=<?php echo $_GET[id]; ?>&amp;d=del&amp;id_link=<?php echo $row[$i][id_link]; ?>#terkait"> Hapus</a></td>
							</tr>
							<tr>
...
?>
							...
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td colspan="2"><input class="inputsubmit" type="submit" name="submit_link_pernakpernik" value="Kirim" />&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>
							<tr>
								<td colspan="4"><hr /></td>
							</tr>

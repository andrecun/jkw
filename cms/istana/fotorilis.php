...
<?php include("../istana/pers.nav.php"); ?>
			...
			<table class="tablebg2" width="100%" cellspacing="0" cellpadding="12">
				<tr>
					<td valign="top">
						...
						<form action="../istana/?file=fotorilis" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td>
									<ul>
										<li><a href="../istana/?file=fotorilis">Terbaru...</a></li>
									<?php
									...
									?>
										<li><a href="../istana/?file=fotorilis&amp;bln=<?php echo"$bln"; ?>&amp;thn=<?php echo"$thn"; ?>"><?php conv_bln("$bln"); echo" $thn"; ?></a></li>
									<?php
									}
									?>
									</ul>

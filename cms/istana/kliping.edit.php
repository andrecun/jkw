			...
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						...
						$tahun = $row[tahun];
						?>
						<form action="../istana/?file=kliping_edit&amp;id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data">
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								<td><?php echo"$bhs_kli_category"; ?></td>
								<td>:</td>
								<td>
									<select class="inputtext" name="kategori">
										<option value=""><?php echo"$bhs_kli_select_category"; ?></option>
										<option value="">---</option>
										<?php
							...
							<tr>
								<td valign="top"><?php echo"$bhs_kli_content"; ?></td>
								<td valign="top">:</td>
							...
							<tr>
								...
								<td>
								<?php if ($row[status]=="0") { ?>
									<input type="radio" name="status" value="0" checked="checked" /> <?php echo"$bhs_kli_pending"; ?> <input type="radio" name="status" value="1" /> <?php echo"$bhs_kli_publish"; ?>
								<?php } elseif ($row[status]=="1") { ?>
									<input type="radio" name="status" value="0" /> <?php echo"$bhs_kli_pending"; ?> <input type="radio" name="status" value="1" checked="checked" /> <?php echo"$bhs_kli_publish"; ?>
								<?php } ?>
								</td>
							</tr>
							<tr>

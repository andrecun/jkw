	...
	<tr>
		<td>
			...
			?>
				...
				<form action="../istana/?file=kliping_cat" method="post" enctype="multipart/form-data">
				<input type="hidden" name="id" value="<?php echo $row[id]; ?>" />
					...
					<td width="10">&nbsp;</td>
					<td width="40" align="center"><a href="../istana/?file=kliping_cat&amp;mode=submit_del_cat_news&amp;id=<?php echo $row[id]; ?>"  onclick="return confirm('<?php echo"$bhs_confirm_del"; ?> ?')"><img src="/images/del.png" border="0" alt="<?php echo"$bhs_kli_delete"; ?>" /></a></td>
					<td width="100">&nbsp;</td>
				</form>
				</tr>
				<tr>

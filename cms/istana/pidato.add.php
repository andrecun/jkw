			...
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						...
						<form action="../istana/?file=pidato_add" method="post" enctype="multipart/form-data">
						<input type="hidden" name="penulis" value="<?php echo"$userku"; ?>" />
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td colspan="3"><b><?php echo"$bhs_pdt_add_news"; ?></b></td>
							</tr>
							<?php if ($verify_news!="") { ?>
							<tr>
							...
							<tr>
								...
								<td>:</td>
								<td><input type="radio" name="status" value="0" /> <?php echo"$bhs_pdt_pending"; ?> <?php if (($levelku=="1") || ($levelku=="2") || ($levelku=="3")) { ?> <input type="radio" name="status" value="1" checked='checked' /> <?php echo"$bhs_pdt_publish"; ?> <?php } else { } ?></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>

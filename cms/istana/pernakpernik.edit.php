...
<?php include("pernakpernik.nav.php"); ?>
	...
	<tr>
		<td>
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td width="60"><img src="/images/news.png" border="0" alt="<?php echo"$bhs_fks_pernakpernik"; ?>" /></td>
					<td><font size="3"><b><?php echo"$bhs_fks_pernakpernik"; ?></b></font></td>
				</tr>
			</table>
			...
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						<?php
						$sql = mysql_query("select *, DAYOFMONTH(waktu) as tanggal, MONTH(waktu) as bulan, YEAR(waktu) as tahun, SECOND(waktu) as detik, MINUTE(waktu) as menit, HOUR(waktu) as jam from pernakpernik where id='".$_GET['id']."'");
						...
						$tahun = $row[tahun];
						?>
						<form action="./?file=pernakpernik_edit&amp;id=<?php echo $_GET['id']; ?>" method="POST" enctype="multipart/form-data">
						<input type="hidden" name="id" value="<?php echo $row[id]; ?>" />
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td colspan="3"><b><?php echo"$bhs_fks_edit_pernakpernik"; ?></b></td>
							</tr>
							<?php if ($verify_pernakpernik!="") { ?>
							<tr>
								<td colspan="3"><font color="red"><?php echo"$verify_pernakpernik"; ?></font></td>
							</tr>
							<?php } ?>
							<tr>
                ...
                (this.checked) {
                    ...
                    document.getElementById('english_option').style.display = 'block';
						...
						if($row[ContentTypeR]!='')
							{
						?>
								<img src="/istana/imageR.php/<?php echo $_GET[id];  ?>.jpg"/>
						<?php
						...
						if($row[ContentTypeD]!='')
							{
						?>
								<img src="/istana/imageD.php/<?php echo $_GET[id];  ?>.jpg"/>
						<?php
							} else { echo "gambar tidak tersedia"; }
						?>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="subjudul_id" value="<?php echo $row[subjudul_id]; ?>" size="60" /></td>
							</tr>
							<tr>
								<td><?php echo"Judul"; ?></td>
								<td>:</td>
								<td><input class="inputtext" type="text" name="judul_id" value="<?php echo nl2br($row[judul_id]); ?>" size="60" /></td>
							</tr>
							<tr>
								<td valign="top"><?php echo"Ringkasan Berita "; ?></td>
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="5" cols="60" name="cuplikan_id"><?php echo $row[cuplikan_id]; ?></textarea></td>
							</tr>
							<tr>
								<td valign="top"><?php echo"Berita Selengkapnya "; ?></td>
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="25" cols="120" name="isi_id"><?php echo nl2br($row[isi_id]); ?></textarea></td>
							</tr>
							<tr>
								<td colspan="3">&nbsp;</td>
							</tr>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="subjudul_en" value="<?php echo $row[subjudul_en]; ?>" size="60" /></td>
							</tr>
							<tr>
								<td><?php echo"Title "; ?></td>
								<td>:</td>
								<td><input class="inputtext" type="text" name="judul_en" value="<?php echo nl2br($row[judul_en]); ?>" size="60" /></td>
							</tr>
							<tr>
								<td valign="top"><?php echo"Summary "; ?></td>
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="5" cols="60" name="cuplikan_en"><?php echo $row[cuplikan_en]; ?></textarea></td>
							</tr>
							<tr>
								<td valign="top"><?php echo"News "; ?></td>
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="25" cols="120" name="isi_en"><?php echo nl2br($row[isi_en]); ?></textarea></td>
							</tr>
						</table>
						</fieldset>
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><input class="inputsubmit" type="submit" name="submit_edit_pernakpernik" value="<?php echo"$bhs_submit"; ?>" />&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>
						</table>
						</form>
					</td>

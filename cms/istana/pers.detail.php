		...
		<td>
			...
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						<?php
						$sql = mysql_query("select * from pers where id='".$_GET['id']."'");
						...
						<table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
							...
							<tr>
								...
								<td valign="top">:</td>
								<td><?php echo"$row[keterangan_id]"; ?></td>
							</tr>
							<tr>
								<td valign="top"><?php echo"Keterangan"; ?></td>
								<td valign="top">:</td>
								<td><?php echo"$row[keterangan_en]"; ?></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>:</td>
								<td><?php if ($row[status]!="0") {echo"<font color='blue'>$bhs_prs_published</font>";} else {echo"<font color='red'>$bhs_prs_pending</font>";} ?></td>
							</tr>
							<tr>
								<td colspan="3">&nbsp;</td>
							</tr>

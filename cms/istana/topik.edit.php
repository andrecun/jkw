...
<?php
include("../istana/topik.nav.php"); 
if($_POST['submit_edit_topik']!='')
	include("../istana/topik.exe.php");
?>
			...
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						...
						$tahun = $row[tahun];
						?>
						<form action="../istana/?file=topik_edit&amp;id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data">
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								<td>Keyword</td>
								<td>:</td>
								<td><input class="inputtext" type="text" name="judul_id" value="<?php echo"$row[keyword_id]"; ?>" size="60" /></td>
							</tr>
							<tr>
								<td valign="top">Ringkasan</td>
								<td>:</td>
								<td><textarea class="inputtext" rows="15" cols="120" name="isi_id"><?php echo"$row[cuplikan_id]"; ?></textarea></td>
							</tr>
							<tr>
							...
							<tr>
								<td>Keyword</td>
								<td>:</td>
								<td><input class="inputtext" type="text" name="judul_id" value="<?php echo"$row[keyword_en]"; ?>" size="60" /></td>
							</tr>
							<tr>
								<td valign="top">Summary</td>
								<td>:</td>
								<td><textarea class="inputtext" rows="15" cols="120" name="isi_id"><?php echo"$row[cuplikan_en]"; ?></textarea></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
								<?php if ($row[status]=="0") { ?>
									<input type="radio" name="status" value="0" checked="checked" /> <?php echo"$bhs_tpk_pending"; ?> <input type="radio" name="status" value="1" /> <?php echo"$bhs_tpk_publish"; ?>

	...
	<tr>
		<td>
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td width="60"><img src="/images/news.png" border="0" alt="<?php echo"$bhs_prs_news"; ?>" /></td>
					<td><font size="3"><b><?php echo"$bhs_prs_news"; ?></b></font></td>
				</tr>
			</table>
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						...
						<form action="../istana/?file=pers_add" method="post" enctype="multipart/form-data">
						<input type="hidden" name="penulis" value="<?php echo"$userku"; ?>" />
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td colspan="3"><b><?php echo"$bhs_prs_add_news"; ?></b></td>
							</tr>
							<?php if ($verify_news!="") { ?>
							<tr>
							...
							<tr>
								...
								<td>
									<select class="inputtext" name="tgl">
										...
										<option value="">-------</option>
										<option value="1">Keterangan Pers Presiden</option>
										<option value="2">Keterangan Pers Juru Bicara Presiden</option>
										<option value="3">Pers Rilis</option>
									</select>
								</td>
							</tr>
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="tempat" value="<?php echo"$tempat"; ?>" size="30" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="10" cols="120" name="keterangan_id"><?php echo"$keterangan_id"; ?></textarea></td>
							</tr>
							<tr>
								<td valign="top"><?php echo"Keterangan"; ?></td>
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="10" cols="120" name="keterangan_en"><?php echo"$keterangan_en"; ?></textarea></td>
							</tr>
							<tr>
							...
							<tr>
								<td><?php echo"$bhs_prs_status"; ?></td>
								<td>:</td>
								<td><input type="radio" name="status" value="0" /> <?php echo"$bhs_prs_pending"; ?> <?php if (($levelku=="1") || ($levelku=="2") || ($levelku=="3")) { ?> <input type="radio" name="status" value="1" checked='checked' /> <?php echo"$bhs_prs_publish"; ?> <?php } else { } ?></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><input class="inputsubmit" type="submit" name="submit_add_pers" value="<?php echo"$bhs_submit"; ?>" />&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>
						</table>
						</form>
					</td>

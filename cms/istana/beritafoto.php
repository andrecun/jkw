...
<?php include("../istana/beritafoto.nav.php"); ?>
			...
			<table class="tablebg2" width="100%" cellspacing="0" cellpadding="12">
				<tr>
					<td valign="top">
						...
						<form action="../istana/?file=beritafoto" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td>
									<ul>
										<li><a href="../istana/?file=beritafoto">Terbaru...</a></li>
									<?php
									...
									?>
										<li><a href="../istana/?file=beritafoto&amp;bln=<?php echo"$bln"; ?>&amp;thn=<?php echo"$thn"; ?>"><?php conv_bln("$bln"); echo" $thn"; ?></a></li>
									<?php
									}
									?>
									</ul>
					...
					<td valign="top">
						...
						if (($_GET['bln']!="") && ($_GET['thn']!="")) {
							$sql = mysql_query("select *, DATE_FORMAT(waktu, '%d/%m/%Y') as waktu from beritafoto where DATE_FORMAT(waktu, '%m')='".$_GET['bln']."' and DATE_FORMAT(waktu, '%Y')='".$_GET['thn']."' order by waktu desc");
						} else {
							$sql = mysql_query("select *, DATE_FORMAT(waktu, '%d/%m/%Y') as waktu from beritafoto order by waktu desc limit 0,10");
						}
						?>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>

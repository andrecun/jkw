...
<form action="../istana/?file=search&amp;keyword=<?php echo $_GET[keyword]; ?>&amp;tabel=<?php echo $_GET[tabel]; ?>" method="get">
&nbsp;<font class="header3"><?php echo"$bhs_sch_search "; ?></font>&nbsp;
...
&nbsp;<font class="header3"><?php echo"$bhs_sch_at "; ?></font>&nbsp;

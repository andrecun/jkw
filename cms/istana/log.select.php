...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
	<tr>
		...
		<td align="right">
			<a href="../istana/?file=log&amp;mode=submit_empty_log" onclick="return confirm('<?php echo"$bhs_confirm_del"; ?> ?')"><font style="color:white; background-color:red; font-weight:bold;"> &nbsp;&nbsp; Empty Log &nbsp; </font></a>
		</td>
	</tr>
</table>
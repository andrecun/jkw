			...
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						...
						<form action="./?file=pernakpernik_add" method="post" enctype="multipart/form-data">
						<input type="hidden" name="penulis" value="<?php echo"$userku"; ?>" />
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td colspan="3" valign="top"><b><?php echo"$bhs_fks_add_pernakpernik"; ?></b></td>
							</tr>
                ...
                (this.checked) {
                    ...
                    document.getElementById('english_option').style.display = 'block';
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="deskripsi" value="<?php echo"$subjudul_id"; ?>" size="60" /></td>
							</tr>
							</table>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="subjudul_id" value="<?php echo"$subjudul_id"; ?>" size="60" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="5" cols="60" name="cuplikan_id"><?php echo"$cuplikan_id"; ?></textarea></td>
							</tr>
							<tr>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="subjudul_en" value="<?php echo"$subjudul_en"; ?>" size="60" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="5" cols="60" name="cuplikan_en"><?php echo"$cuplikan_en"; ?></textarea></td>
							</tr>
							<tr>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><input class="inputsubmit" type="submit" name="submit_add_pernakpernik" value="<?php echo"$bhs_submit"; ?>" />&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>
						</table>
						</form>
					</td>

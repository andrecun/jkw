		...
		<td>
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr bgcolor="<?php echo"$tdcol"; ?>" onmouseover="setPointer(this, '#ADD6FF')" onmouseout="setPointer(this, '<?php echo"$tdcol"; ?>')">
					...
					<td width="100"><?php echo"$row[kategori]"; ?></td>
					<td><div style="padding:5px 0px 5px 0px"><?php echo"$row[judul_id]"; ?><hr width="95%" align="left" /><?php echo"$row[judul_en]"; ?></div></td>
					<td width="160">&nbsp;&nbsp; &bull; <a href="../istana/?file=pers_detail&amp;id=<?php echo $row[id]; ?>">Detail</a> &bull; <a href="#">Status</a> &bull; <a href="#">Edit</a> &bull; <a href="#">Delete</a></td>
					<td width="10">&nbsp;</td>
				</tr>
				<tr>
					<td colspan="6" bgcolor="#dddddd"><img src="/images/x.gif" border="0" alt="" /></td>
				...
				?>
				<tr>
					<td colspan="6" height="30" align="right"><?php echo"$bhs_prs_total"; ?> : <?php echo"$total"; ?> data</td>
				</tr>
				<tr>
					<td colspan="6">

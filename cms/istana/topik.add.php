			...
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						...
						<form action="../istana/?file=topik_add" method="post" enctype="multipart/form-data">
						<input type="hidden" name="penulis" value="<?php echo"$userku"; ?>" />
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td colspan="3"><b><?php echo"$bhs_tpk_add_topik"; ?></b></td>
							</tr>
							<?php if ($verify_topik!="") { ?>
							<tr>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="keyword_id" value="<?php echo"$keyword_id"; ?>" size="60" /></td>
							</tr>
							<tr>
							...
							<tr>
								<td><?php echo"Keyword"; ?></td>
								<td>:</td>
								<td><input class="inputtext" type="text" name="keyword_en" value="<?php echo"$keyword_en"; ?>" size="60" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>:</td>
								<td><input type="radio" name="status" value="0" checked='checked'/> <?php echo"$bhs_tpk_pending"; ?> <?php if (($levelku=="1") || ($levelku=="2") || ($levelku=="3")) { ?> <input type="radio" name="status" value="1"/> <?php echo"$bhs_tpk_publish"; ?> <?php } else { } ?></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><input class="inputsubmit" type="submit" name="submit_add_topik" value="<?php echo"$bhs_submit"; ?>" />&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>
						</table>
						</form>
					</td>

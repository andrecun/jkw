					...
					<td>
						...
						<table width="100%" border="0" bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0">
							<tr bgcolor="#cccccc">
								...
								<td class="menu"><a href="../ibunegara/?file=logbysession&amp;order=session&amp;sort=asc"><img src="/images/asc.png" border="0" alt="asc" hspace="2" /></a><b>Session</b><a href="../ibunegara/?file=logbysession&amp;order=session&amp;sort=desc"><img src="/images/desc.png" border="0" alt="desc" hspace="2" /></a></td>
								<td class="menu" height="30">&nbsp;</td>
							</tr>
							<?php
							$limit = 20;

			...
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						...
						<form action="./?file=mutiara_add" method="post" enctype="multipart/form-data">
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="tempat" value="<?php echo"$_POST[tempat]"; ?>" size="30" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="event" value="<?php echo"$_POST[event]"; ?>" size="60" /></td>
							</tr>
							<tr>
								<td valign="top"><?php echo"Isi Mutiara Kata"; ?></td>
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="8" cols="60" name="mutiara"><?php echo"$_POST[mutiara]"; ?></textarea></td>
							</tr>
							<tr>
							...
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><input class="inputsubmit" type="submit" name="submit_add_mutiara" value="<?php echo"$bhs_submit"; ?>" />&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>
						</table>
						</form>
					</td>

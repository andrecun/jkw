			...
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						...
						$tahun = $row[tahun];
						?>
						<form action="./?file=pidato_edit&amp;id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data">
						<input type="hidden" name="id" value="<?php echo $row[id]; ?>" />
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td colspan="3" valign="top"><b><?php echo"$bhs_fks_add_pidato"; ?></b></td>
							</tr>
							<?php if ($verify_pidato!="") { ?>
							<tr>
								<td colspan="3"><font color="red"><?php echo"$verify_pidato"; ?></font></td>
							</tr>
							<?php } ?>
														<tr>
								<td width="100">Tempat</td>
								<td>:</td>
								<td><input class="inputtext" type="text" name="tempat" value="<?php echo $row[tempat]; ?>" size="60" /></td>
							</tr>
                ...
                (this.checked) {
                    ...
                    document.getElementById('english_option').style.display = 'block';
							...
							<tr>
								...
								<img src="/ibunegara/imagePidatoR.php/<?php echo $_GET[id]; ?>.jpg" />
								<?php } else echo "Foto Detail tidak tersedia"; ?>								
								<br />
								Ganti Foto Ringkasan yang lain :<br />
							...
							<tr>
								...
								<img src="/ibunegara/imagePidatoD.php/<?php echo $_GET[id]; ?>.jpg" />
								<?php } else echo "Foto Detail tidak tersedia"; ?>
								<br />
								Ganti Foto Detail yang lain :<br />								
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="TemaSiaran" value="<?php echo $row[TemaSiaran]; ?>" size="60" /></td>
							</tr>
							</table>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="judul_id" value="<?php echo stripslashes($row[judul_id]); ?>" size="60" /></td>
							</tr>
							<tr>
								<td valign="top"><?php echo"Ringkasan "; ?></td>
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="5" cols="60" name="ringkasan_id"><?php echo stripslashes($row[cuplikan_id]); ?></textarea></td>
							</tr>
							<tr>
								<td valign="top"><?php echo"Pidato Selengkapnya "; ?></td>
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="25" cols="120" name="isi_id"><?php echo stripslashes($row[isi_id]); ?></textarea></td>
							</tr>
							<tr>
								<td colspan="3">&nbsp;</td>
							</tr>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="judul_en" value="<?php echo stripslashes($row[judul_en]); ?>" size="60" /></td>
							</tr>
							<tr>
								<td valign="top"><?php echo"Summary"; ?></td>
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="5" cols="60" name="ringkasan_en"><?php echo stripslashes($row[cuplikan_en]); ?></textarea></td>
							</tr>							<tr>
								<td valign="top"><?php echo"Speech in detail"; ?></td>
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="25" cols="120" name="isi_en"><?php echo stripslashes($row[isi_en]); ?></textarea></td>
							</tr>
						</table>
						</fieldset>
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><input class="inputsubmit" type="submit" name="submit_edit_pidato" value="<?php echo"$bhs_submit"; ?>" />&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>
						</table>
						</form>
					</td>

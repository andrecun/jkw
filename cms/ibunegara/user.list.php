...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="menu" width="100"><a href="../ibunegara/?file=user_main&amp;order=username&amp;sort=asc"><img src="/images/asc.png" border="0" alt="asc" hspace="2" /></a><b><?php echo"$bhs_um_username"; ?></b><a href="../ibunegara/?file=user_main&amp;order=username&amp;sort=desc"><img src="/images/desc.png" border="0" alt="desc" hspace="2" /></a></td>
		<td class="menu" width="200"><a href="../ibunegara/?file=user_main&amp;order=name&amp;sort=asc"><img src="/images/asc.png" border="0" alt="asc" hspace="2" /></a><b><?php echo"$bhs_um_name"; ?></b><a href="../ibunegara/?file=user_main&amp;order=name&amp;sort=desc"><img src="/images/desc.png" border="0" alt="desc" hspace="2" /></a></td>
		<td class="menu" width="80" align="center"><a href="../ibunegara/?file=user_main&amp;order=level&amp;sort=asc"><img src="/images/asc.png" border="0" alt="asc" hspace="2" /></a><b><?php echo"$bhs_um_level"; ?></b><a href="../ibunegara/?file=user_main&amp;order=level&amp;sort=desc"><img src="/images/desc.png" border="0" alt="desc" hspace="2" /></a></td>
		<td class="menu" width="100" align="center"><a href="../ibunegara/?file=user_main&amp;order=datereg&amp;sort=asc"><img src="/images/asc.png" border="0" alt="asc" hspace="2" /></a><b><?php echo"$bhs_um_date_reg"; ?></b><a href="../ibunegara/?file=user_main&amp;order=datereg&amp;sort=desc"><img src="/images/desc.png" border="0" alt="desc" hspace="2" /></a></td>
	...
	<tr bgcolor="<?php echo"$tdcol"; ?>" onmouseover="setPointer(this, '#ADD6FF')" onmouseout="setPointer(this, '<?php echo"$tdcol"; ?>')">
		...
		<?php if ($levelku=="1") { ?>
			<?php if ($row[status]=="0") { ?>
				<a href="../ibunegara/?file=user_main&amp;mode=submit_active_user&amp;uid=<?php echo"$row[uid]"; ?>"><img src="/images/publish.png" border="0" alt="<?php echo"$bhs_um_active"; ?>" /></a>
			<?php } elseif ($row[status]=="1") { ?>
				<a href="../ibunegara/?file=user_main&amp;mode=submit_pending_user&amp;uid=<?php echo"$row[uid]"; ?>"><img src="/images/unpublish.png" border="0" alt="<?php echo"$bhs_um_pending"; ?>" /></a>
			<?php } else {} ?>
		<?php } else { ?>
			<?php if ($row[status]=="0") { ?>
		...
		<td width="40" align="center"><a href="../ibunegara/?file=user_edit&amp;username=<?php echo"$row[username]"; ?>#edituser"><img src="/images/edit.png" border="0" alt="<?php echo"$bhs_um_edit"; ?>" /></a></td>
		<td width="40" align="center">
			<?php if (($levelku=="1") && ($row[username]==$superuser)) { ?>
				<a href="../ibunegara/?file=user_password&amp;mode=change_password&amp;username=<?php echo"$userku"; ?>#password"><img src="/images/add.png" border="0" alt="<?php echo"$bhs_um_change"; ?>" /></a>
			<?php } elseif ($row[username]==$userku) { ?>
				<a href="../ibunegara/?file=user_password&amp;mode=change_password&amp;username=<?php echo"$userku"; ?>#password"><img src="/images/add.png" border="0" alt="<?php echo"$bhs_um_change"; ?>" /></a>
			<?php } else { ?>
				<a href="../ibunegara/?file=user_password&amp;mode=reset_password&amp;username=<?php echo"$row[username]"; ?>#password"><img src="/images/add.png" border="0" alt="<?php echo"$bhs_um_reset"; ?>" /></a>
			<?php } ?>
		</td>
		<td width="40" align="center">
			...
			<?php } else { ?>
				<a href="../ibunegara/?file=user_main&amp;mode=submit_del_user&amp;username=<?php echo"$row[username]"; ?>&amp;level=<?php echo"$row[level]"; ?>" onclick="return confirm('<?php echo"$bhs_confirm_del"; ?>')"><img src="/images/del.png" border="0" alt="<?php echo"$bhs_um_delete"; ?>" /></a>
			<?php } ?>
		</td>
		<td>&nbsp;</td>
	</tr>

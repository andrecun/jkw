...
<title>CMS Web Ibu Negara RI Hj. Ani Bambang Yudhoyono</title>
	...
	<tr>
		<td class="header3">
			<table width="100%" border="0" cellspacing="0" cellpadding="2">
				<tr>
					<td height="35" align="left"> &nbsp;&nbsp; <a href="/cms/ibunegara/"><font class="header3">[<?php echo"$bhs_home"; ?>]</font></a> <!--<a href="../ibunegara/?file=user_main"><font class="header3">[<?php echo"$bhs_user_manager"; ?>]</font></a>--> <!--<a href="../ibunegara/?file=banner_main"><font class="header3">[<?php echo"$bhs_banner"; ?>]</font></a>--> <a href="../ibunegara/?file=log"><font class="header3">[<?php echo"$bhs_log"; ?>]</font></a> <a href="../logout.php" onclick="return confirm('<?php echo"$bhs_confirm_logout"; ?>')"><font color="red">[<b><?php echo"$bhs_logout"; ?></b>]</font></a></td>

			...
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						...
						<form action="./?file=beritafoto_add" method="post" enctype="multipart/form-data">
						<input type="hidden" name="penulis" value="<?php echo"$userku"; ?>" />
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td colspan="3" valign="top"><b><?php echo"$bhs_fks_add_beritafoto"; ?></b></td>
							</tr>
...
<?php if ($levelku!="1") { echo"$bhs_fks_pending"; echo "<input type=\"hidden\" name=\"status\" value=\"0\"";  } else { ?>
							...
							<tr>
								<td>Foto Kecil</td>
								<td>:</td>
								<td><input class="inputtext" type="file" name="FotoR" size="30" />&nbsp;(lebar maksimum: 218 pixel)</td>
							</tr>
							<tr>
								<td>Foto Besar</td>
								<td>:</td>
								<td><input class="inputtext" type="file" name="FotoD" size="30" />&nbsp;(lebar maksimum: 530 pixel)</td>
							</tr>
							<!--<tr>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="judul" value="<?php echo"$judul_id"; ?>" size="60" /></td>
							</tr>
							<tr>
								<td valign="top"><?php echo"Ringkasan Berita "; ?></td>
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="5" cols="60" name="Ringkasan"><?php echo"$cuplikan_id"; ?></textarea></td>
							</tr>
							<tr>
								<td valign="top"><?php echo"Berita Selengkapnya "; ?></td>
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="25" cols="120" name="isi"><?php echo"$isi_id"; ?></textarea></td>
							</tr>
							<tr>
								<td colspan="3">&nbsp;</td>
							</tr>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><input class="inputsubmit" type="submit" name="submit_add_beritafoto" value="<?php echo"$bhs_submit"; ?>" />&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>
						</table>
						</form>
					</td>

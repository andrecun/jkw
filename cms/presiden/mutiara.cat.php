	...
	<tr>
		<td>
			...
			?>
				...
				<form action="./?file=news_cat" method="post" enctype="multipart/form-data">
				<input type="hidden" name="id" value="<?php echo $row[id]; ?>" />
					<td width="100">&nbsp;</td>
					<td><img src="/images/cek.png" border="0" alt="" /></td>
					<td><input class="inputtext" type="text" size="25" name="kategori" value="<?php echo"$row[kategori]"; ?>" /></td>
					<td><input class="inputtext" type="text" size="25" name="kategori" value="<?php echo"$row[kategori]"; ?>" /></td>
					<td align="center"><input class="inputsubmit" type="submit" name="submit_edit_cat_news" value="<?php echo"$bhs_save_changes"; ?>" /></td>
					<td width="10">&nbsp;</td>
					<td width="40" align="center"><a href="./?file=news_cat&amp;mode=submit_del_cat_news&amp;id=<?php echo $row[id]; ?>"  onclick="return confirm('<?php echo"$bhs_confirm_del"; ?> ?')"><img src="/images/del.png" border="0" alt="<?php echo"$bhs_pdt_delete"; ?>" /></a></td>
					<td width="100">&nbsp;</td>
				</form>
				</tr>
				<tr>
					...
					<td>
						...
						<table width="400" border="0" align="center" cellpadding="2" cellspacing="0">
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="kategori" size="50" /></td>
							</tr>
							<tr>
								<td><?php echo"$bhs_pdt_category"; ?></td>
								<td>:</td>

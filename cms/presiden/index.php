...
include"serbaserbi.exe.php";
include"kibar.exe.php";
include"video.exe.php";
...
<title>CMS Web Presiden RI </title>
	...
	<tr>
		<td class="header3">
			<table width="100%" border="0" cellspacing="0" cellpadding="2">
				<tr>
					<td height="35" align="left"> &nbsp; <a href="/cms/presiden/"><font class="header3">[<?php echo"$bhs_home"; ?>] <a href="./?file=user_main"><font class="header3">[<?php echo"$bhs_user_manager"; ?>]</font></a> <!--<a href="./?file=banner_main"><font class="header3">[<?php echo"$bhs_banner"; ?>]</font></a>--> <a href="./?file=log"><font class="header3">[<?php echo"$bhs_log"; ?>]</font></a> <a href="../logout.php" onclick="return confirm('<?php echo"$bhs_confirm_logout"; ?>')"><font color="red">[<b><?php echo"$bhs_logout"; ?></b>]</font></a></font></a></td>
                                                         

<!--                                                           <td height="35" align="right">
                                                                <a href="./?file=buku_main"><span class="style1">Buku</span></a> | <a href="./?file=km0_main"><span class="style1">Km 0,00</span></a> | 
					<a href="./?file=kibar_main"><span class="style1">Kibar</span></a> |
					<a href="./?file=serbaserbi_main"><span class="style1">Sudut Istana</span></a> | 
					<a href="./?file=aktual_main"><span class="style1">Fokus Aktual</span></a> | <!--<a href="./?file=audio_main"><span class="style1">Audio</span></a> | <a href="./?file=sms_main"><span class="style1">SMS 2222 9949</span></a> | <a href="./?file=pobox_main"><span class="style1">PO BOX 9949</span></a> | <a href="?file=message_main"><span class="style1">Kotak Pesan</span></a> | <a href="?file=video_main"><span class="style1">Video</span></a>&nbsp;&nbsp;
                                                           </td>-->
                              <td height="35" align="right">
                                                                 <a href="./?file=km0_main"><span class="style1">Agenda</span></a> | 
					<a href="./?file=serbaserbi_main"><span class="style1">Sudut Istana</span></a> | 
					<a href="./?file=aktual_main"><span class="style1">Fokus Aktual</span></a> | <a href="?file=message_main"><span class="style1">Kotak Pesan</span></a> | <a href="?file=video_main"><span class="style1">Video</span></a>&nbsp;&nbsp;
                                                           </td>
	...
	<tr>
		<td>
			...
			elseif	($file=='serbaserbi_main')			{ include("serbaserbi.main.php"); }
			elseif	($file=='serbaserbi_add')			{ include("serbaserbi.add.php"); }
			elseif	($file=='serbaserbi_detail')			{ include("serbaserbi.detail.php"); }
			elseif	($file=='serbaserbi_edit')			{ include("serbaserbi.edit.php"); }
			elseif	($file=='serbaserbi_cat')			{ include("serbaserbi.cat.php"); }

			elseif	($file=='kibar_main')			{ include("kibar.main.php"); }
			elseif	($file=='kibar_add')			{ include("kibar.add.php"); }
			elseif	($file=='kibar_detail')			{ include("kibar.detail.php"); }
			elseif	($file=='kibar_edit')			{ include("kibar.edit.php"); }
			elseif	($file=='kibar_cat')			{ include("kibar.cat.php"); }
			...
			elseif	($file=='aktual_main')			{ include("aktual.main.php"); }
			elseif	($file=='aktual_add')			{ include("aktual.add.php"); }
			elseif	($file=='aktual_detail')		{ include("aktual.detail.php"); }
			elseif	($file=='aktual_edit')			{ include("aktual.edit.php"); }
			elseif	($file=='aktual_cat')			{ include("aktual.cat.php"); }			
			...
			elseif	($file=='km0_main')				{ include("km0.main.php"); }
			elseif	($file=='km0_add')				{ include("km0.add.php"); }
			elseif	($file=='km0_detail')			{ include("km0.detail.php"); }
			elseif	($file=='km0_edit')				{ include("km0.edit.php"); }
			elseif	($file=='km0_cat')				{ include("km0.cat.php"); }
			...
			elseif	($file=='mutiara_edit')			{ include("mutiara.edit.php"); }
                                    ...
                                    elseif	($file=='buku_main')			{ include("buku.main.php"); }
			elseif	($file=='buku_add')			{ include("buku.add.php"); }
			elseif	($file=='buku_detail')		{ include("buku.detail.php"); }
			elseif	($file=='buku_edit')			{ include("buku.edit.php"); }    
                                        

			elseif	($file=='audio_main')			{ include("audio.main.php"); }
			elseif	($file=='audio_add')			{ include("audio.add.php"); }
			elseif	($file=='audio_detail')			{ include("audio.detail.php"); }
			elseif	($file=='audio_edit')			{ include("audio.edit.php"); }
			elseif	($file=='video_main')			{ include("video.main.php"); }
			elseif	($file=='video_add')			{ include("video.add.php"); }
			elseif	($file=='video_detail')			{ include("video.detail.php"); }
			elseif	($file=='video_edit')			{ include("video.edit.php"); }
			elseif	($file=='generator')			{ include("generator.php"); }

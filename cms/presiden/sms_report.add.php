					...
					<td>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="judul_id" value="<?php echo"$judul_id"; ?>" size="20" maxlength="20" /></td>
							</tr>
							...
							<tr>
								...
								<td valign="top">:</td>
								<td><input class="inputtext" maxLength="200" size="35" name="judul_id"> <input type="submit" value="browse" name="B1" class="inputsubmit"></td>
							</tr>
							<tr>

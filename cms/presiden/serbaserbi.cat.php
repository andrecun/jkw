...
<table class="tablebg1" width="100%" cellspacing="0" cellpadding="4" align="center">
	<tr>
		<td>
			...
			<?php
			$sql = mysql_query("select * from fokus_cat order by id asc");
			...
			?>
				...
				<form action="./?file=fokus_cat" method="post" enctype="multipart/form-data">
				<input type="hidden" name="id" value="<?php echo $row[id]; ?>" />
					...
					<td width="10">&nbsp;</td>
					<td width="40"><div style="padding:5px 0px 5px 0px"><a href="./?file=fokus_cat&amp;mode=submit_del_cat_fokus&amp;id=<?php echo $row[id]; ?>"  onclick="return confirm('<?php echo"$bhs_confirm_del"; ?> ?')"><?php echo"$bhs_fks_delete"; ?></a></div></td>
					<td width="100">&nbsp;</td>
				</form>
				</tr>
				<tr>

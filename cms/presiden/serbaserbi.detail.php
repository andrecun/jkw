...
<form action="?file=serbaserbi_detail&amp;id=<?php echo $_GET[id]; ?>#terkait" method="post" enctype="multipart/form-data">
		...
		<td>
			...
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						<?php
						$sql = mysql_query("select *, DAYNAME(waktu) as hari, DAYOFMONTH(waktu) as tgl, MONTH(waktu) as bln, YEAR(waktu) as thn, DATE_FORMAT(waktu, '%H:%i:%s') as jam from serbaserbi where id='".$_GET['id']."'");
						...
						<table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
							...
							<tr>
								...
								<td>:</td>
								<td><?php if ($row[status]!="0") {echo"<font color='blue'>$bhs_ss_published</font>";} else {echo"<font color='red'>$bhs_ss_pending</font>";} ?></td>
							</tr>
							<tr>
								<td colspan="3">&nbsp;</td>
							</tr>
							...
							<tr>
								<td width="110"><?php echo"$bhs_ss_title"; ?></td>
								<td width="5">:</td>
							...
							<tr>
								<td valign="top"><?php echo"$bhs_ss_content"; ?></td>
								<td valign="top">:</td>

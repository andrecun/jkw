...
if ($_POST['submit_add_fokus']) {
	...
	//else {
		...
		$logsql = "insert into log (session,module,username,ip,logtime,act,object)
					values ('$session','fokus','$userku','$ip',now(),'add fokus','')";
...
if ($_POST['submit_edit_fokus']) {
		// begin log ************************************************************
		$logsql = "insert into log (session,module,username,ip,logtime,act,object)
					values ('$session','fokus','$userku','$ip',now(),'edit fokus','')";
		$logrow = mysql_query($logsql) or die(mysql_error());
		// end log ************************************************************
...
if($levelku==1) {
if (($_GET['action'] == "status")&&($_GET['file'] == "fokus_main")&&($_GET['status'] == "0")) {
	// begin log ************************************************************
	$logsql = "insert into log (session,module,username,ip,logtime,act,object) 
				values ('$session','fokus','$userku','$ip',now(),'publish fokus','')";
	$logrow = mysql_query($logsql) or die(mysql_error());
	// end log ************************************************************
...
if (($_GET['action'] == "status")&&($_GET['file'] == "fokus_main")&&($_GET['status'] == "1")) {
	// begin log ************************************************************
	$logsql = "insert into log (session,module,username,ip,logtime,act,object) 
				values ('$session','fokus','$userku','$ip',now(),'pending fokus','')";
	$logrow = mysql_query($logsql) or die(mysql_error());
	// end log ************************************************************
...
if (($_GET['action'] == "delete")&&($_GET['file'] == "fokus_main")) {
	// begin log ************************************************************
	$logsql = "insert into log (session,module,username,ip,logtime,act,object) 
				values ('$session','fokus','$userku','$ip',now(),'delete fokus','')";
	$logrow = mysql_query($logsql) or die(mysql_error());
	// end log ************************************************************
		
	$sql = "delete from fokus where id='".$_GET['id']."'";
	$result = mysql_query($sql) or die(mysql_error());
	$sql = "delete from fokus_link where fokus_id='".$_GET['id']."'";
	$result = mysql_query($sql) or die(mysql_error());
}
if (($_GET['file'] == "fokus_detail")&&($_GET['d'] == "del")) {
	// begin log ************************************************************
	$logsql = "insert into log (session,module,username,ip,logtime,act,object) 
				values ('$session','fokus','$userku','$ip',now(),'delete fokus','')";
	$logrow = mysql_query($logsql) or die(mysql_error());
	...
	$sql = "delete from fokus_link where id='".$_GET['id_link']."' AND fokus_id='".$_GET['id']."'";
	$result = mysql_query($sql) or die(mysql_error());
}
}
// fokus /////////////////////////////////////////////////////////////////////////////////////////////////
...
if ($_POST['submit_link_fokus']) {
		...
		// begin log ************************************************************
		$logsql = "insert into log (session,module,username,ip,logtime,act,object)
					values ('$session','fokus','$userku','$ip',now(),'add fokus link terkait','')";
		$logrow = mysql_query($logsql) or die(mysql_error());
		// end log ************************************************************
...
if ($_POST['edit_link_fokus']) {
		...
		// begin log ************************************************************
		$logsql = "insert into log (session,module,username,ip,logtime,act,object)
					values ('$session','fokus','$userku','$ip',now(),'edit fokus link terkait','')";
		$logrow = mysql_query($logsql) or die(mysql_error());
		// end log ************************************************************
/*
...
if ($_POST['submit_add_cat_fokus']) {
	...
	elseif ($kategori_en=="") { }
		...
		// begin log ************************************************************
		$logsql = "insert into log (session,module,username,ip,logtime,act,object) 
					values ('$session','fokus','$userku','$ip',now(),'add fokus category','')";
		$logrow = mysql_query($logsql) or die(mysql_error());
		// end log ************************************************************
...
if ($_POST['submit_edit_cat_fokus']) {
	...
	elseif ($kategori_en=="") { }
		...
		// begin log ************************************************************
		$logsql = "insert into log (session,module,username,ip,logtime,act,object) 
					values ('$session','fokus','$userku','$ip',now(),'edit fokus category','')";
		$logrow = mysql_query($logsql) or die(mysql_error());
		// end log ************************************************************
...
if ($_GET['mode'] == "submit_del_cat_fokus") {
	// begin log ************************************************************
	$logsql = "insert into log (session,module,username,ip,logtime,act,object) 
				values ('$session','fokus','$userku','$ip',now(),'delete fokus category','')";
	$logrow = mysql_query($logsql) or die(mysql_error());
	// end log ************************************************************

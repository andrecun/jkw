					...
					<td>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								...
								<td>:</td>
								<td><?php if($row[ContentTypeD]!='') { ?><img src="/imageWawancaraR.php/<?php echo $_GET[id]; ?>.jpg" alt="" /><?php } else echo "Gambar tidak tersedia";?></td>
							</tr>
							<tr>
								<td>Foto Detil</td>
								<td>:</td>
								<td><?php if($row[ContentTypeD]!='') { ?><img src="/imageWawancaraD.php/<?php echo $_GET[id]; ?>.jpg" alt="" /><?php } else echo "Gambar tidak tersedia";?></td>
							</tr>
							<tr>

			...
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						...
						<form action="./?file=serbaserbi_add" method="post" enctype="multipart/form-data">
						<input type="hidden" name="penulis" value="<?php echo"$userku"; ?>" />
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td colspan="3" valign="top"><b><?php echo"$bhs_ss_add_serbaserbi"; ?></b></td>
							</tr>
							<?php if ($verify_serbaserbi!="") { ?>
							<tr>
								<td colspan="3"><font color="red"><?php echo"$verify_serbaserbi"; ?></font></td>
							</tr>
							<?php } ?>
							<tr>
								...
								<td valign="top">
									...
									<input type="text" class="inputtext" name="jam" size="2" value="<?php echo"$jam"; ?>" />&nbsp;:&nbsp;
									<input type="text" class="inputtext" name="mnt" size="2" value="<?php echo"$menit"; ?>" />&nbsp;:&nbsp;
									<input type="text" class="inputtext" name="dtk" size="2" value="<?php echo"$detik"; ?>" />
								</td>
							</tr>
							<tr>
								<td><?php echo"$bhs_ss_status"; ?></td>
								<td>:</td>
								<td>
 <?php if ($levelku!="1") { echo"$bhs_ss_pending"; echo "<input type=\"hidden\" name=\"status\" value=\"0\"";  } else { ?>
								<input type="radio" name="status" value="0"  checked='checked' /> <?php echo"$bhs_ss_pending"; ?>
								<input type="radio" name="status" value="1"/> 
								<?php echo"$bhs_ss_publish"; ?> <?php } ?></td>
							</tr>
							<tr>
							<input type="hidden" name="english" value="0" />
								<td>Foto Ringkasan</td>
								<td>:</td>
								<td><input class="inputtext" type="file" name="FotoRingkasan" size="30" /> (Ukuran: 64 x 64 pixel)</td>
							</tr>
							<tr>
								<td>Foto Detil</td>
								<td>:</td>
								<td><input class="inputtext" type="file" name="FotoDetil" size="30" /> (Lebar Maksimum: 220 pixel)</td>
							</tr>
							<tr>
								<td width="100" valign="top">Keterangan Foto</td>
								<td valign="top">:</td>
								<td><input class="inputtext" type="text" name="deskripsi" value="<?php echo htmlentities($subjudul_id); ?>" size="80" />
								<br />Contoh: Presiden SBY dengan Ny.Herawati BM Diah di Bandung Kamis (9/2). (foto:abror)</td>
							</tr>
							</table>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="subjudul_id" value="<?php echo htmlentities($subjudul_id); ?>" size="60" /></td>
							</tr>
							<tr>
							...
							<tr>
								<td valign="top"><?php echo"Ringkasan Sudut Istana "; ?></td>
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="5" cols="60" name="cuplikan_id"><?php echo htmlentities($cuplikan_id); ?></textarea></td>
							</tr>
							<tr>
								<td valign="top"><?php echo"Sudut Istana Selengkapnya "; ?></td>
								<td valign="top">:</td>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="subjudul_en" value="<?php echo htmlentities($subjudul_en); ?>" size="60" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="5" cols="60" name="cuplikan_en"><?php echo htmlentities($cuplikan_en); ?></textarea></td>
							</tr>
							<tr>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><input class="inputsubmit" type="submit" name="submit_add_serbaserbi" value="<?php echo"$bhs_submit"; ?>" />&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>
						</table>
						</form>
					</td>

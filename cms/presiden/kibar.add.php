			...
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						...
						<form action="./?file=kibar_add" method="post" enctype="multipart/form-data">
						<input type="hidden" name="penulis" value="<?php echo"$userku"; ?>" />
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td colspan="3" valign="top"><b><?php echo"$bhs_kb_add_kibar"; ?></b></td>
							</tr>
							<?php if ($verify_kibar!="") { ?>
							<tr>
							...
							<tr>
								...
								<td>:</td>
								<td>
 <?php if ($levelku!="1") { echo"$bhs_kb_pending"; echo "<input type=\"hidden\" name=\"status\" value=\"0\"";  } else { ?>
								<input type="radio" name="status" value="0"  checked='checked' /> <?php echo"$bhs_kb_pending"; ?>
								<input type="radio" name="status" value="1"/> 
								<?php echo"$bhs_kb_publish"; ?> <?php } ?></td>
							</tr>
							<tr>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><input class="inputsubmit" type="submit" name="submit_add_kibar" value="<?php echo"$bhs_submit"; ?>" />&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>
						</table>
						</form>
					</td>

			...
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						...
						<form action="./?file=pers_add" method="post" enctype="multipart/form-data">
						<input type="hidden" name="penulis" value="<?php echo"$userku"; ?>" />
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td colspan="3"><b><?php echo"$bhs_prs_add_pers"; ?></b></td>
							</tr>
							<?php if ($verify_pers!="") { ?>
							<tr>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="tempat" value="Jakarta" size="44" /></td>
							</tr>
							<tr>
                    ...
                    document.getElementById('english_option').style.display = 'block';
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="judul_id" value="<?php echo htmlentities($judul_id); ?>" size="120" /></td>
							</tr>
							<tr>

		...
		<td>
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td class="menu">&nbsp;</td>
					<td class="menu"><b><?php echo"$bhs_kli_category"; ?></b></td>
					<td class="menu"><b><?php echo"$bhs_kli_category"; ?></b></td>
					<td class="menu" align="center"><b><?php echo"$bhs_kli_action"; ?></b></td>
					<td class="menu">&nbsp;</td>
					<td class="menu" align="center"><b><?php echo"$bhs_kli_delete"; ?></b></td>
					<td class="menu" height="30">&nbsp;</td>
				</tr>
				<tr>
					<td colspan="8" bgcolor="#dddddd"><img src="/images/x.gif" border="0" alt="" /></td>
			...
			?>
				...
				<form action="./?file=kliping_cat" method="post" enctype="multipart/form-data">
				<input type="hidden" name="id" value="<?php echo $row[id]; ?>" />
					...
					<td width="10">&nbsp;</td>
					<td width="40" align="center"><a href="./?file=kliping_cat&amp;mode=submit_del_cat_news&amp;id=<?php echo $row[id]; ?>"  onclick="return confirm('<?php echo"$bhs_confirm_del"; ?> ?')"><img src="/images/del.png" border="0" alt="<?php echo"$bhs_kli_delete"; ?>" /></a></td>
					<td width="100">&nbsp;</td>
				</form>
				</tr>
				<tr>
				...
				<tr>
					<td>
						...
						<table width="400" border="0" align="center" cellpadding="2" cellspacing="0">
							<tr>
								<td colspan="3"><b><?php echo"$bhs_kli_add_cat"; ?></b></td>
							</tr>
							<tr>

			...
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						...
						<form action="./?file=kliping_add" method="post" enctype="multipart/form-data">
						<input type="hidden" name="penulis" value="<?php echo"$userku"; ?>" />
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td colspan="3"><b><?php echo"$bhs_kli_add_news"; ?></b></td>
							</tr>
							<?php if ($verify_news!="") { ?>
							<tr>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="judul" value="<?php echo htmlentities($judul_id); ?>" size="100" /></td>
							</tr>
							<tr>
								<td><?php echo"Nama Sumber"; ?></td>
								<td>:</td>
								<td><input class="inputtext" type="text" name="sumber" value="<?php echo htmlentities($sumber); ?>" size="100" /></td>
							</tr>
							<tr>
								<td><?php echo"URL sumber"; ?></td>
								<td>:</td>
								<td><input class="inputtext" type="text" name="url" value="<?php echo htmlentities($url); ?>" size="60" /></td>
							</tr>
                                          <tr>
								<td valign="top"><?php echo"Isi  "; ?></td>
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="25" cols="120" name="isi_id"></textarea></td>
							</tr>
							<tr>
							...
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><input class="inputsubmit" type="submit" name="submit_add_kliping" value="<?php echo"$bhs_submit"; ?>" />&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>
						</table>
						</form>
					</td>

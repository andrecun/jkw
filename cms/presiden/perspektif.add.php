...
<?php if (($levelku=="1") ||($levelku=="2") ){ ?>
 ...
 <?php if ($levelku!="1") { echo"$bhs_fks_pending";  } else { ?>
							...
							<tr>
								...
								<td valign="top">:</td>
								<td><input class="inputtext" type="text" name="penulis" value="<?php echo"$judul_id"; ?>" size="60" /></td>
							</tr>
							<tr>
							...
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><input class="inputsubmit" type="submit" name="submit_add_perspektif" value="<?php echo"$bhs_submit"; ?>" />&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>
						</table>
						</form>
					</td>

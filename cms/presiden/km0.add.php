...
<?php if (($levelku=="1") ||($levelku=="2") ){ ?>
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						...
						<form action="./?file=sms_add" method="post" enctype="multipart/form-data">
						<input type="hidden" name="penulis" value="<?php echo"$userku"; ?>" />
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td colspan="3"><b><?php echo"Tambah Dari Kilometer 0,00"; ?></b></td>
							</tr>
							<?php if ($verify_news!="") { ?>
							<tr>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="judul" value="<?php echo"$tempat"; ?>" size="90" /></td>
							</tr>
							<tr>
 ...
 <?php if ($levelku!="1") { echo"$bhs_fks_pending";  } else { ?>
							...
							<!--<tr>
								<td valign="top"><?php echo"Sumber"; ?></td>
								<td valign="top">:</td>
								<td><input class="inputtext" type="text" name="penulis" value="<?php echo"$judul_id"; ?>" size="60" /><br /></td>
							</tr>-->
							<!--
							<tr>
								<td valign="top"><?php echo"URL Sumber"; ?></td>
								<td valign="top">:</td>
								<td><input class="inputtext" type="text" name="media" value="<?php echo"$judul_id"; ?>" size="60" /><br />Format URL harus lengkap, contoh: http://www.indonesia.go.id</td>
							</tr>
							-->
														<!--<tr>
								<td valign="top"><?php echo"Ringkasan"; ?></td>
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="8" cols="60" name="ringkasan"><?php echo"$isi_en"; ?></textarea></td>
							</tr>-->	
<tr>
								<td valign="top"><?php echo"Isi Selengkapnya"; ?></td>
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="25" cols="110" name="isi"><?php echo"$isi_en"; ?></textarea></td>
							</tr>						
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><input class="inputsubmit" type="submit" name="submit_add_km0" value="<?php echo"$bhs_submit"; ?>" />&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>
						</table>
						</form>
					</td>

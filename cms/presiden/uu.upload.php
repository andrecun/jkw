					...
					<td>
						...
						<table width="100%" border="0" align="center" cellpadding="1" cellspacing="0">
							...
							<tr>
								...
								<td>&nbsp;</td>
								<td>
									<a href="./?file=uu_detail&amp;id=<?php echo $row[id]; ?>"><img src="/images/view.png" border="0" alt="<?php echo"$bhs_dwn_view"; ?>" /></a>
									
									<?php if ($row[status]=="0") { ?>
										<a href="./?file=uu_upload&amp;mode=submit_publish_download&amp;id=<?php echo $row[id]; ?>"><img src="/images/publish.png" border="0" alt="<?php echo"$bhs_dwn_publish"; ?>" /></a>
									<?php } elseif ($row[status]=="1") { ?>
										<a href="./?file=uu_upload&amp;mode=submit_pending_download&amp;id=<?php echo $row[id]; ?>"><img src="/images/unpublish.png" border="0" alt="<?php echo"$bhs_dwn_pending"; ?>" /></a>
									<?php } else {} ?>
									
									<a href="./?file=uu_edit&amp;id=<?php echo $row[id]; ?>"><img src="/images/edit.png" border="0" alt="<?php echo"$bhs_dwn_edit"; ?>" /></a>
									
									<a href="./?file=uu_main&amp;mode=submit_del_download&amp;id=<?php echo $row[id]; ?>"  onclick="return confirm('<?php echo"$bhs_confirm_del"; ?> ?')"><img src="/images/del.png" border="0" alt="<?php echo"$bhs_dwn_delete"; ?>" /></a>
								</td>
							</tr>
							<tr>
								<td colspan="3">&nbsp;</td>
								...
								<td colspan="3">
									...
									?>
										<tr bgcolor="#ffffff">
											...
											<td width="40" align="center"><a href="./?file=uu_upload&amp;id=<?php echo"$rowfl[pid]"; ?>&amp;upload=<?php echo"$rowfl[file]"; ?>&amp;mode=submit_del_download_file&amp;idfile=<?php echo"$rowfl[id]"; ?>" onclick="return confirm('<?php echo"$bhs_confirm_del"; ?> ?')"><img src="/images/del2.png" border="0" width="16" height="16" alt="<?php echo"$bhs_dwn_delete"; ?>" /></a></td>
										</tr>
									<?php
									$i++; 
									} 
							...
							<tr>
								<td>
									<form action="./?file=uu_upload&amp;id=<?php echo $row[id]; ?>" method="post" enctype="multipart/form-data">

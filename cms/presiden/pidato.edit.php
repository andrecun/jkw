                ...
                (this.checked) {
                    ...
                    document.getElementById('english_option').style.display = 'block';
							...
							<tr>
								...
								<img src="/imagePidatoR.php/<?php echo $_GET[id]; ?>.jpg" alt="" />
							...
							<tr>
								...
								<img src="/imagePidatoD.php/<?php echo $_GET[id]; ?>.jpg" />
								<?php } else echo "Foto Detail tidak tersedia"; ?>
								<br />
							...
							<tr>
								...
								<?php 
								echo "<a href='/DokumenPidato.php?id=".$_GET[id]."' target=\"_blank\">Dokumen tersedia dengan format $doktype</a>";
									}

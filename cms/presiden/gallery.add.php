...
<INPUT type="hidden" name="menit" value="<?php echo $menit; ?>">
<INPUT type="hidden" name="detik" value="<?php echo $detik; ?>">
 ...
 <?php if ($levelku!="1") { echo"$bhs_fks_pending"; echo "<input type=\"hidden\" name=\"status\" value=\"0\"";  } else { ?>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="file" name="FotoR" size="30" /> (Ukuran: 64 x 64 pixel)</td>
							</tr>
							<tr>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="album" value="<?php echo"$subjudul_id"; ?>" size="60" /></td>
							</tr>
							<tr>
								<td colspan="3">&nbsp;</td>
							</tr>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><input class="inputsubmit" type="submit" name="submit_add_gallery" value="<?php echo"$bhs_submit"; ?>" />&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>
						</table>
						</form>
					</td>

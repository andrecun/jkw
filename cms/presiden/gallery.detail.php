...
?>
						...
						<img width="200" src="/imageGalleryD.php/<?php echo $row[id]; ?>.jpg" /><br /><?php conv_hari($row['hari']); echo ", ".$row['tgl']." "; conv_bln($row['bln']); echo " ".$row['thn']; ?><br /><?php echo $row[ringkasan]; ?> </td>
...
<img width=\"200\" src=\"/imageGalleryD.php/$row[id].jpg \" /><br />";
?>

...
<?php if (($levelku=="1") ||($levelku=="2")||($levelku=="5") ){ ?>
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						<?php
$sql = mysql_query("select *, DAYOFMONTH(tglAwal) as tglAwal, MONTH(tglAwal) as blnAwal, YEAR(tglAwal) as thnAwal, DAYOFMONTH(tglAkhir) as tglAkhir, MONTH(tglAkhir) as blnAkhir, YEAR(tglAkhir) as thnAkhir from pobox where id='".$_GET['id']."'");
...
&nbsp;-&nbsp;&nbsp;
						...
						?><br /><?php echo"Ubah File Grafik"; ?>: <input class="inputtext" type="file" name="grafik" size="30" /></td>
							</tr>
							<tr>
							...
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><input class="inputsubmit" type="submit" name="submit_edit_pobox" value="<?php echo"$bhs_submit"; ?>" />&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>

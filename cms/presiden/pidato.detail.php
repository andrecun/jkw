		...
		<td>
			...
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						<?php
						$sql = mysql_query("select *, DAYNAME(waktu) as hari, DAYOFMONTH(waktu) as tgl, MONTH(waktu) as bln, YEAR(waktu) as thn from pidato where id='".$_GET['id']."'");
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								...
								<td>:</td>
								<td><?php if($row[ContentTypeR]!='') { ?><img src="/imagePidatoR.php/<?php echo $_GET[id]; ?>.jpg" alt="" /><?php } else echo "Gambar tidak tersedia";?></td>
							</tr>
							<tr>
								<td>Foto Detil</td>
								<td>:</td>
								<td><?php if($row[ContentTypeD]!='') { ?><img src="/imagePidatoD.php/<?php echo $_GET[id]; ?>.jpg" alt="" /><?php } else echo "Gambar tidak tersedia";?></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>:</td>
								<td><?php echo htmlentities($row[TemaSiaran]); ?></td>
							</tr>
							</table>
<?php
if($row[bahasa]==0)
...
?>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								...
								<td valign="top">:</td>
								<td><?php echo nl2br(htmlentities($row[cuplikan_id])); ?></td>
							</tr>
							<tr>

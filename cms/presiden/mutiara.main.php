		...
		<td>
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td class="menu" width="70"><b><?php echo"Tempat"; ?></b></td>
					<td class="menu" width="70"><b><?php echo"Tanggal"; ?></b></td>
					<td class="menu" width="70"><b><?php echo"Event"; ?></b></td>					
					<td class="menu"><b><?php echo"isi"; ?></b></td>
					<td class="menu" align="center" width="70"><b><?php echo"Status"; ?></b></td>					
				...
				//} else {
					$target = "file=mutiara_main";
					$sql = "select *, DATE_FORMAT(waktu, '%d/%m/%Y') as tanggal from mutiara order by waktu desc";
				//}
				...
				<tr bgcolor="<?php echo"$tdcol"; ?>" onmouseover="setPointer(this, '#ADD6FF')" onmouseout="setPointer(this, '<?php echo"$tdcol"; ?>')">
					...
					<td><div style="padding:5px 0px 5px 0px"><?php echo"$row[mutiara]"; ?></div></td>
					...
					<td width="180" align="center">&nbsp;&nbsp;&bull;&nbsp;<a href="?file=mutiara_detail&amp;id=<?php echo $row[id]; ?>">Detail</a>&nbsp;&bull;&nbsp;<?php
					if($levelku==1)
					{
					echo "<a href=\"?file=mutiara_main&amp;action=status&amp;id=";
					echo $row[id];
					echo "&amp;status=";
				    echo $row[status]; 
				    echo "\">Status</a> &bull;&nbsp;";
					...
					{
?><a href="?file=mutiara_edit&amp;id=<?php echo $row[id]; ?>">Edit</a>&nbsp;&bull;&nbsp;<?php
					}
					else echo "Edit&nbsp;&bull;&nbsp;";
					if(($levelku==1))
					{
					echo "<a href=\"?file=mutiara_main&amp;action=delete&amp;id=";
					echo $row[id];
					echo "\" onclick=\"return confirm('Apakah Anda yakin untuk menghapus Mutiara Kata &quot;$row[judul_id]&quot;')\">Delete</a>";
					}else {
?>Delete<?php
						}
?></td>					<td width="10">&nbsp;</td>
				...
				?>
				<tr>
					<td colspan="8" height="30" align="right"><?php echo"$bhs_pdt_total"; ?> : <?php echo"$total"; ?> data</td>
				</tr>
				<tr>
					<td colspan="8">

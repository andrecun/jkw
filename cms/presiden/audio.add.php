...
<?php if (($levelku=="1") ||($levelku=="2") ){ ?>
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						...
						<form action="./?file=audio_add" method="post" enctype="multipart/form-data">
						<input type="hidden" name="penulis" value="<?php echo"$userku"; ?>" />
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td width="100">Tema Siaran</td>
								<td>:</td>
								<td><input class="inputtext" type="text" name="TemaSiaran" value="<?php echo"$subjudul_id"; ?>" size="60" /></td>
							</tr>				
							<?php if ($verify_audio!="") { ?>
							<tr>
								<td colspan="3"><font color="red"><?php echo"$verify_audio"; ?></font></td>
							</tr>
							<?php } ?>
							<tr>
 ...
 <?php if ($levelku!="1") { echo"$bhs_fks_pending"; echo "<input type=\"hidden\" name=\"status\" value=\"0\"";  } else { ?>
							...
							<tr>
								...
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="5" cols="60" name="ringkasan_id"><?php echo"$ringkasan_id"; ?></textarea></td>
							</tr>							
							<tr>
								<td>Alamat URL WMA</td>
								<td>:</td>
								<td><input class="inputtext" type="text" name="alamatWMA" value="<?php echo"$subjudul_id"; ?>" size="60" /></td>
							</tr>	
							<tr>
								<td>Alamat URL MP3</td>
								<td>:</td>
								<td><input class="inputtext" type="text" name="alamatMP3" value="<?php echo"$subjudul_id"; ?>" size="60" /></td>
							</tr>	
														<tr>
								<td>Alamat URL OGG</td>
								<td>:</td>
								<td><input class="inputtext" type="text" name="alamatOGG" value="<?php echo"$subjudul_id"; ?>" size="60" /></td>
							</tr>	
							</table>
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><input class="inputsubmit" type="submit" name="submit_add_audio" value="<?php echo"$bhs_submit"; ?>" />&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>
						</table>
						</form>
					</td>

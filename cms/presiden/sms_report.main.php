	...
	<tr>
		<td>
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td width="60"><img src="/images/sms.png" border="0" alt="<?php echo"sms"; ?>" /></td>
					<td><font size="3"><b><?php echo"SMS"; ?></b></font></td>
				</tr>
			</table>
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td class="menu" width="100"><b><?php echo"Periode Waktu"; ?></b></td>
					<td class="menu"><b><?php echo"Jumlah Total SMS"; ?></b></td>
				...
				<tr bgcolor="<?php echo"$tdcol"; ?>" onmouseover="setPointer(this, '#ADD6FF')" onmouseout="setPointer(this, '<?php echo"$tdcol"; ?>')">
					...
					<td width="160">&nbsp;&nbsp; &bull; <a href="./?file=pidato_detail&amp;id=<?php echo $row[id]; ?>">Detail</a> &bull; <a href="#">Status</a> &bull; <a href="#">Edit</a> &bull; <a href="#">Delete</a></td>
					<td width="10">&nbsp;</td>
				</tr>
				<tr>
					<td colspan="5" bgcolor="#dddddd"><img src="/images/x.gif" border="0" alt="" /></td>

...
&nbsp;-&nbsp;&nbsp;
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="total" value="<?php echo"$judul_id"; ?>" size="20" maxlength="20" /></td>
							</tr>
							...
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><input class="inputsubmit" type="submit" name="submit_add_sms" value="<?php echo"$bhs_submit"; ?>" />&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>

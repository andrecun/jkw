			...
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						...
						<form action="./?file=buku_add" method="post" enctype="multipart/form-data">
						<input type="hidden" name="penulis" value="<?php echo"$userku"; ?>" />
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td colspan="3"><b><?php echo"Judul Buku"; ?></b></td>
							</tr>
							<?php if ($verify_news!="") { ?>
							<tr>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="judul" value="<?php echo"$_POST[judul]"; ?>" size="30" /></td>
							</tr>
							<tr>
								...
								<td>Cover</td>
								<td>:</td>
								<td><input class="inputtext" type="file" name="Cover" size="30" /> (Lebar Maksimum: 220 pixel)</td>
							</tr>
							<tr>
								<td valign="top"><?php echo"Cuplikan Buku"; ?></td>
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="8" cols="60" name="cuplikan"><?php echo"$_POST[cuplikan]"; ?></textarea></td>
							</tr>
							<tr>
								<td valign="top"><?php echo"Isi Buku"; ?></td>
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="8" cols="60" name="buku"><?php echo"$_POST[buku]"; ?></textarea></td>
							</tr>
							<tr>
							...
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><input class="inputsubmit" type="submit" name="submit_add_buku" value="<?php echo"$bhs_submit"; ?>" />&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>
						</table>
						</form>
					</td>

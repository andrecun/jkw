                ...
                (this.checked) {
                    ...
                    document.getElementById('english_option').style.display = 'block';
							...
							<tr>
								...
								<img src="/imagePidatoR.php?id=<?php echo $_GET[id]; ?>" />
							...
							<tr>
								...
								<img src="/imagePidatoD.php?id=<?php echo $_GET[id]; ?>" />
								<?php } else echo "Foto Detail tidak tersedia"; ?>
								<br />
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="alamatWMA" value="<?php echo $row[alamatWMA]; ?>" size="60" /></td>
							</tr>	
							<tr>
								<td>Alamat URL MP3</td>
								<td>:</td>
								<td><input class="inputtext" type="text" name="alamatMP3" value="<?php echo $row[alamatMP3]; ?>" size="60" /></td>
							</tr>	
														<tr>
								<td>Alamat URL OGG</td>
								<td>:</td>
								<td><input class="inputtext" type="text" name="alamatOGG" value="<?php echo $row[alamatOGG]; ?>" size="60" /></td>
							</tr>	
							</table>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								...
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="25" cols="120" name="ringkasan_en"><?php echo stripslashes($row[cuplikan_en]); ?></textarea></td>
							</tr>
							<tr>

					...
					<td valign="top">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td><a href="./?file=gallery_detail&amp;id=<?php echo"$row[id]"; ?>"><b><?php echo"$row[album]"; ?></b> &nbsp; (&nbsp;<?php if ($row2[jumlah]>0) echo $row2[jumlah]; else echo "0"; ?> <?php if ($row2[jumlah]==1) {echo"pic";} else {echo"pics";} ?>&nbsp;)</a></td>
							</tr>
...
<?php $detik = date("s"); $menit = date("i"); $jam = date("H"); $tanggal = date("d"); $bulan = date("m"); $tahun = date("Y"); ?>
						...
						<table width="70%" border="0" align="center" cellpadding="1" cellspacing="0">
							...
							<tr>
								...
								<td>:<input class="inputtext" type="hidden" name="ringkasan" value="&nbsp;"></td>
								<td><textarea class="inputtext" rows="5" cols="60" name="deskripsi"></textarea></td>
							</tr>
							<tr>
								<td colspan="3">&nbsp;</td>
							</tr>

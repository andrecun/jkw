	...
	<tr>
		<td>
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td width="60"><img src="/images/gallery.png" border="0" alt="<?php echo"berita foto"; ?>" /></td>
					<td><font size="3"><b><?php echo"Berita Foto"; ?></b></font></td>
				</tr>
			</table>
<?php if (($levelku=="1") ||($levelku=="2")||($levelku=="3") ){ ?>
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						<?php
						$sql = mysql_query("select *, DAYOFMONTH(waktu) as tanggal, MONTH(waktu) as bulan, YEAR(waktu) as tahun, SECOND(waktu) as detik, MINUTE(waktu) as menit, HOUR(waktu) as jam from beritafoto where id='".$_GET['id']."'");
						...
						$tahun = $row[tahun];
						?>
						<form action="./?file=beritafoto_edit&amp;id=<?php echo $_GET['id']; ?>" method="POST" enctype="multipart/form-data">
						<input type="hidden" name="id" value="<?php echo $row[id]; ?>" />
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td colspan="3"><b><?php echo"$bhs_fks_edit_beritafoto"; ?></b></td>
							</tr>
 ...
 <?php if ($levelku!="1") { echo"$bhs_fks_pending";  } else { ?>
						...
						?>
								...
								<img src="/imageBeritafotoR.php/<?php echo $_GET[id];  ?>.jpg"/>
						<?php
							} else { echo "gambar tidak tersedia"; }
						?>
								
								<br />Ganti Foto :<br /><input class="inputtext" type="file" name="FotoR" size="60" /></td>
							</tr>
							<tr>
						...
						?>
								...
								<img src="/imageBeritafotoD.php/<?php echo $_GET[id];  ?>.jpg"/>
						<?php
							} else { echo "gambar tidak tersedia"; }
						?>
								<br />Ganti Foto :<br /><input class="inputtext" type="file" name="FotoD" size="30" />
								</td>
							</tr>
							<!--<tr>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							...
							<tr>
								...
								<td>:</td>
								<td><input class="inputtext" type="text" name="judul" value="<?php echo htmlentities($row[judul]); ?>" size="60" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td valign="top">:</td>
								<td><textarea class="inputtext" rows="25" cols="120" name="isi"><?php echo $row[isi]; ?></textarea></td>
							</tr>
							<tr>
								<td colspan="3">&nbsp;</td>
							</tr>
						...
						<table width='100%' border='0' align='center' cellpadding='2' cellspacing='0'>
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><input class="inputsubmit" type="submit" name="submit_edit_beritafoto" value="<?php echo"$bhs_submit"; ?>" />&nbsp;<input class="inputsubmit" type="reset" value="<?php echo"$bhs_reset"; ?>" /></td>
							</tr>
						</table>
						</form>
					</td>

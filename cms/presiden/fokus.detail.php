		...
		<td>
			...
			<table class="tablebg2" width="100%" align="center" cellpadding="4" cellspacing="0">
				<tr>
					<td>
						<?php
						$sql = mysql_query("select *, DAYNAME(waktu) as hari, DAYOFMONTH(waktu) as tgl, MONTH(waktu) as bln, YEAR(waktu) as thn, DATE_FORMAT(waktu, '%H:%i:%s') as jam from fokus where id='".$_GET['id']."'");
						...
						<table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
							...
							<tr>
								<td width="110"><?php echo"$bhs_fks_title"; ?></td>
								<td width="5">:</td>
...
?>
							...
							<tr>
								<td width="110"><?php echo"Sub Title"; ?></td>
								<td width="5">:</td>
...
?>
							<tr>
								...
								<td align="right">&bull;<a href="?file=fokus_detail&amp;id=<?php echo $_GET[id]; ?>&amp;d=edit&amp;id_link=<?php echo htmlentities($row[$i][id_link]); ?>#terkait"> Perubahan</a> &bull; <a onclick="return confirm('Hapus links terkait?');" href="?file=fokus_detail&amp;id=<?php echo $_GET[id]; ?>&amp;d=del&amp;id_link=<?php echo htmlentities($row[$i][id_link]); ?>#terkait"> Hapus</a></td>
							</tr>
							<tr>
